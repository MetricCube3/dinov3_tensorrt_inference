...
class SelfAttention(nn.Module):
    ...
    def compute_attention(self, qkv: Tensor, attn_bias=None, rope=None) -> Tensor:
        ...
        # Explicit attention with MANUAL softmax to break TensorRT Myelin's
        # flash-attention fusion (which miscomputes for num_heads=6 / seq_len=1029
        # with RoPE + massive activations). Manual softmax => no `Softmax` op for
        # Myelin's pattern matcher to latch onto, forcing plain matmul kernels.
        head_dim = q.shape[-1]
